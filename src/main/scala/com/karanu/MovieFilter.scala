...
object MovieFilter {
  def main(args: Array[String]) {
    ...
    // input file
    val input = "src/main/resources/ml-latest-small/movies.csv"
    ...
    // records are stored in directory filter-output
    movies.writeAsText("src/main/resources/filter-output")
